...
export const reasonTips: Record<string, { title: string; description: string; variant: 'info' | 'warning' | 'success' }> = {
  emergency: {
    title: 'Fondo de Emergencia',
    description: 'Un fondo ideal cubre 3-6 meses de gastos fijos. Asócialo a una cuenta de alta liquidez.',
    variant: 'warning'
  },
  elderly: {
    title: 'Ahorro a Largo Plazo',
    description: 'Para retiro, piensa en plazos mayores a 5 años. Una cuenta con interés compuesto maximiza tu ahorro.',
    variant: 'info'
  },
  home: {
    title: 'Vivienda',
    description: 'Define el monto de la cuota inicial. Un CDT a mediano plazo (1-3 años) es buena opción.',
    variant: 'info'
  },
  school: {
    title: 'Educación',
    description: 'Calcula matrícula + materiales + gastos mensuales. El plazo depende de cuándo inician los estudios.',
    variant: 'info'
  },
  flight: {
    title: 'Viajes',
    description: 'Define destino y fecha. Ahorro a corto plazo (3-12 meses). Una cuenta básica es suficiente.',
    variant: 'success'
  },
  medical_services: {
    title: 'Salud',
    description: 'Para prevención, reserva 1-2 meses de ingreso. Prioriza liquidez sobre rentabilidad.',
    variant: 'warning'
  },
  payments: {
    title: 'Pago de Deudas',
    description: 'Prioriza las deudas con mayor tasa de interés. Si es recurrente, no necesitas fecha límite.',
    variant: 'warning'
  },
  trending_up: {
    title: 'Inversiones',
