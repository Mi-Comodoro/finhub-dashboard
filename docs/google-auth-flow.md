# Flujo Actual de Autenticacion con Google en Mi Comodoro
...
Hasta aqui, el cliente todavia no tiene una sesion propia de Mi Comodoro; solo tiene identidad validada por Google/Firebase.
...
## Construccion de la sesion de Mi Comodoro
...
Hoy el login con Google en Mi Comodoro funciona como un flujo hibrido:
